package com.hjhq.teamface.email.application;
...
import com.hjhq.teamface.email.EmailTestActivity;
    ...
    public void onEvent(MessageBean event) {
        ...
        switch (code) {
            case EventConstant.LOGIN_TAG:
                CommonUtil.startActivtiyNewTask(this, EmailTestActivity.class);
                break;
            default:
                break;
        }
