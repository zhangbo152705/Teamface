...
public class TaskBoardView extends HorizontalScrollView implements AutoScroller.AutoScrollListener {
    ...
    public ArrayList<View> mHeaders = new ArrayList<>();
    ...
    public TaskBoardView(Context context) {
        super(context);
    }

    public TaskBoardView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TaskBoardView(Context context, AttributeSet attrs, int defStyleAttr) {
