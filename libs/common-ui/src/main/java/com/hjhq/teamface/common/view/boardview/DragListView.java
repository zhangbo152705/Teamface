...
import com.hjhq.teamface.common.view.boardview.swipe.ListSwipeHelper;
...
public class DragListView extends FrameLayout {
    ...
    private DragItemRecyclerView createRecyclerView() {
        final DragItemRecyclerView recyclerView = (DragItemRecyclerView) LayoutInflater.from(getContext()).inflate(R.layout.layout_drag_item_recycler_view, this, false);
