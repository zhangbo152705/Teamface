...
public class BoardView2 extends HorizontalScrollView implements AutoScroller.AutoScrollListener {
    ...
    protected void onFinishInflate() {
        ...
        mColumnLayout.setTag("mColumnLayout");
    ...
    public void scrollToColumn(int column, boolean animate) {
        ...
        if (emptyView != null && column == mLists.size()) {
            ...
            parent = mColumnLayout.getChildAt(column);
        } else {
            /*View v1 = (View) mRefreshLists.get(column > getColumnCount() ? getColumnCount() : column).getParent();
            View v2 = (View) v1.getParent();
            View v3 = (View) v2.getParent();
            parent = (View) v1.getParent();*/
            parent = (View) mRefreshLists.get(column > getColumnCount() ? getColumnCount() : column).getParent();
        }
...
//                    }
    ...
    public DragItemRecyclerView addColumnList(final DragItemAdapter adapter, final View header,
        ...
        final View rootView = LayoutInflater
                .from(getContext())
                .inflate(R.layout.smart_refresh_layout2, this, false);
