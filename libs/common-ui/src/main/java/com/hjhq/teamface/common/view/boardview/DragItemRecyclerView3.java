...
public class DragItemRecyclerView3 extends RecyclerView implements AutoScroller.AutoScrollListener {
    ...
    public DragItemRecyclerView3(Context context) {
        super(context);
        init();
    }

    public DragItemRecyclerView3(Context context, AttributeSet attrs) {
        super(context, attrs, 0);
        init();
    }

    public DragItemRecyclerView3(Context context, AttributeSet attrs, int defStyle) {
