...
package com.hjhq.lib_zxing.decoding;
...
import com.hjhq.lib_zxing.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
    ...
    public void startPreview(CaptureFragment fragment, Vector<BarcodeFormat> decodeFormats,
    ...
    public void handleMessage(Message message) {
        if (message.what == R.id.auto_focus) {
            ...
            Log.e("zxinghandleMessage", message.toString());
            /***********************************************************************/
