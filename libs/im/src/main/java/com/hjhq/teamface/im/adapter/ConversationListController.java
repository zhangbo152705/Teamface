    ...
    private void initConvListAdapter() {
        ...
        mConvListView.addOnItemTouchListener(new SimpleItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                mNotificationManager.cancel(MsgConstant.MESSAGE_CHANNEL, ((Long) netConversationList.get(position).getConversationId()).hashCode());
                notifyMap.put(netConversationList.get(position).getConversationId(), 0);
                updateUnreadNum();
            }
