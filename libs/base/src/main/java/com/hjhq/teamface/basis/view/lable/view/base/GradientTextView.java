package com.hjhq.teamface.basis.view.lable.view.base;
...
public class GradientTextView {
	...
	private void initGradientDrawable() {
		mGradientDrawable.setColor(Color.parseColor("#F4F5F6"));
...
//				.getColor(android.R.color.holo_blue_light));
	...
	private void initLabelTextView() {
		mLabelTextView.setTextSize(TypedValue.COMPLEX_UNIT_SP, 14);
		mLabelTextView.setTextColor(Color.BLACK);
		mLabelTextView.setPadding(dip2px(10), dip2px(10), dip2px(10), dip2px(10));
	}
