...
public class BaseAttendanceInfoBean extends BaseBean {
    ...
    public static class DataBean {
        ...
        private List<BaseAttendanceTypeListBean> attendance_address;
        private List<BaseAttendanceTypeListBean> attendance_wifi;
        private List<BaseAttendanceDataItemBean> clock_record_list;
        private List<BaseAttendanceTypeListBean> relation_module;

        public List<BaseAttendanceDataItemBean> getClock_record_list() {
            return clock_record_list;
        }

        public void setClock_record_list(List<BaseAttendanceDataItemBean> clock_record_list) {
        ...
        public List<BaseAttendanceTypeListBean> getAttendance_address() {
            return attendance_address;
        }

        public void setAttendance_address(List<BaseAttendanceTypeListBean> attendance_address) {
            this.attendance_address = attendance_address;
        }

        public List<BaseAttendanceTypeListBean> getAttendance_wifi() {
            return attendance_wifi;
        }

        public void setAttendance_wifi(List<BaseAttendanceTypeListBean> attendance_wifi) {
            this.attendance_wifi = attendance_wifi;
        }

        public List<BaseAttendanceTypeListBean> getRelation_module() {
            return relation_module;
        }

        public void setRelation_module(List<BaseAttendanceTypeListBean> relation_module) {
