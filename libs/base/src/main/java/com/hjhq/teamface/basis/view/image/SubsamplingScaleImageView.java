...
package com.hjhq.teamface.basis.view.image;
...
//		} 
    ...
    public final void setImageBitmap(Bitmap bitmap, ImageViewState state) {
        ...
        reset(true);
        restoreState(state);
        BitmapInitTask task = new BitmapInitTask(this, getContext(), bitmap, false);
        task.execute();
        invalidate();
//        bitmap.recycle(); 
//        bitmap = null;
    ...
    private static class BitmapInitTask extends AsyncTask<Void, Void, int[]> {
        ...
        public BitmapInitTask(SubsamplingScaleImageView view, Context context, Bitmap bitmap, boolean sourceIsAsset) {
            this.viewRef = new WeakReference<SubsamplingScaleImageView>(view);
            this.contextRef = new WeakReference<Context>(context);
            this.source = null;
            this.bitmap = bitmap;
                    ...
                    if (context != null) {
                        ...
                        if (sourceIsAsset) {
                        	...
                        	if (bitmap != null) {
                                ...
                                decoder = BitmapRegionDecoder.newInstance(sbs, true);
                                sbs.close(); 
                                baos.close();
							} else {
