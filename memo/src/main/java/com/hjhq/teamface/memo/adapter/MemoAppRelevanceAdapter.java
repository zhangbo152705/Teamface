...
public class MemoAppRelevanceAdapter extends BaseQuickAdapter<ModuleResultBean.DataBean, BaseViewHolder> {


    public MemoAppRelevanceAdapter(List<ModuleResultBean.DataBean> data) {
