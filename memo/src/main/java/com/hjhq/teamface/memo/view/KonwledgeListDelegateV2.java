...
public class KonwledgeListDelegateV2 extends AppDelegate {

    @Override
    public int getRootLayoutId() {
        return R.layout.memo_knowledge_activity_main_v2;
    }
    ...
    public void initWidget() {
        ...
        setTitle("知识库");
        setRightMenuIcons(R.drawable.memo_switch_view_icon, R.drawable.icon_filtrate);
