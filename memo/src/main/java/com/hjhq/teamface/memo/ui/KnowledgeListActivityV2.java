...
@RouteNode(path = "/konwledge_main2", desc = "知识库列表")
public class KnowledgeListActivityV2 extends ActivityPresenter<KonwledgeListDelegateV2, MemoModel> {
    ...
    private void switchStyle() {
        mFragmentV2.switchLayoutmanager();
    }
    ...
    private void initFragment() {
        ...
        mFragmentV2 = KnowledgeListFragmentV2.newInstance(0);
        FragmentTransaction mTransaction = mFragmentManager.beginTransaction();
        mTransaction.add(R.id.fl, mFragmentV2);
    ...
    private void memoOperation(String index, String ids) {
        ...
        model.memoOperation(KnowledgeListActivityV2.this, index, ids, new ProgressSubscriber<BaseBean>(KnowledgeListActivityV2.this) {
            @Override
    ...
    private void refreshIfEmpty() {
        mFragmentV2.refreshIfEmpty();
    }

    private void refreshData() {
        /*fragmentList.get(currentIndex).refreshData();*/
        mFragmentV2.refreshData();
    }
