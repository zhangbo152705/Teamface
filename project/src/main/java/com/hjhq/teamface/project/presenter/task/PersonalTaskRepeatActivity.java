...
public class PersonalTaskRepeatActivity extends ActivityPresenter<RepeatTaskDelegate, TaskModel> implements View.OnClickListener {
    ...
    private void getTaskRepeatList() {
        model.getPersonalTaskRepeatList(mContext, taskId, new ProgressSubscriber<TaskRepeatResultBean>(mContext) {
            @Override
    ...
    private void addRepeat() {
        ...
        model.addPersonalTaskRepeat(mContext, bean, new ProgressSubscriber<BaseBean>(mContext) {
            @Override
    ...
    private void editRepeat() {
        ...
        model.editPersonalTaskRepeat(mContext, bean, new ProgressSubscriber<BaseBean>(mContext) {
            @Override
            public void onNext(BaseBean baseBean) {
                super.onNext(baseBean);
