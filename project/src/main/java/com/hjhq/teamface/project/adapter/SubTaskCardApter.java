...
public class SubTaskCardApter extends BaseQuickAdapter<SubTaskBean, BaseViewHolder> {

    boolean isSelect = false;

    public SubTaskCardApter(List<SubTaskBean> data) {
    ...
    protected void convert(BaseViewHolder helper,SubTaskBean item) {
        ...
        if (TextUtil.isEmpty(item.getEmployee_name())){
            ...
            ImageLoader.loadCircleImage(mContext,  item.getEmployee_pic(), ivTaskHead, item.getEmployee_name());
