...
public class TaskStatusResultBean extends BaseBean {
    ...
    public static class DataBean {
        private List<TaskStatusBean> dataList;

        public List<TaskStatusBean> getDataList() {
            return dataList;
        }

        public void setDataList(List<TaskStatusBean> dataList) {
