...
public class MonthDataSubAdapter extends BaseMultiItemQuickAdapter<AttendanceMonthDataBean.AttendanceListBean, BaseViewHolder> {
    private int type;

    public MonthDataSubAdapter(int type, List<AttendanceMonthDataBean.AttendanceListBean> data) {
        super(data);
        this.type = type;
        //迟到,缺卡,旷工,外勤,请假,早退
       /* case "1":
