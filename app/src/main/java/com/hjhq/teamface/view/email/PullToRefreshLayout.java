    ...
    public void loadmoreFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                loadStateImageView.setBackgroundResource(R.drawable.search);
                break;
            case FAIL:
            default:
                // 加载失败
    ...
    private void changeState(int to) {
        ...
        switch (state) {
            case INIT:
                ...
                refreshStateTextView.setText("下拉加载更多");
                pullView.clearAnimation();
            ...
            case RELEASE_TO_REFRESH:
                // 释放刷新状态
                refreshStateTextView.setText("松开加载");
            ...
            case RELEASE_TO_LOAD:
                // 释放加载状态
                loadStateTextView.setText("松开加载2");
