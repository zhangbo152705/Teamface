...
public class EndImageLayout extends ViewGroup {
    ...
    public EndImageLayout(Context context) {
        super(context);
    }

    public EndImageLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public EndImageLayout(Context context, AttributeSet attrs, int defStyleAttr) {
