...
public class CompanyOrganizationFragment2 extends FragmentPresenter<CompanyOrganizationDelegate, CommonModel> implements View.OnClickListener {
    ...
    static CompanyOrganizationFragment2 newInstance(int type) {
        CompanyOrganizationFragment2 myFragment = new CompanyOrganizationFragment2();
    ...
    protected void init() {
        ...
        mEmployeeAdapter.setChooseType(chooseType);
        mDataAdapter.setCheckType(chooseType);
    ...
    private void initData() {
        ...
        model.findUsersByCompany((RxAppCompatActivity) getActivity(), companyId,0, new ProgressSubscriber<GetDepartmentStructureBean>(getActivity()) {
            @Override
